...
List<Job> sampleJobs = [
  ...
  Job(
    title: 'Madhya Pradesh PEB Group 4 Recruitment',
  ...
  Job(
    title: 'Gujarat Junior Clerk Recruitment 2026',
  ...
  Job(
    title: 'Kerala PSC LD Clerk Recruitment 2026',
  ...
  Job(
    title: 'Andhra Pradesh DSC Teacher Recruitment',
    organization: 'AP District Selection Committee',
  ...
  Job(
    title: 'Odisha Staff Nurse Recruitment 2026',
    organization: 'Odisha Health Department',
    location: 'Bhubaneswar, Odisha',
    lastDate: '22 July 2026',
    category: 'Medical',
    applyLink: 'https://health.odisha.gov.in',
  ),
  Job(
    title: 'Haryana Police Sports Quota Recruitment',
